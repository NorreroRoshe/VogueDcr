...
const BottomNavigation: React.FC = () => {
  ...
  return (
    <>
      <div className="diaplaynonemobile hidden-s fixed z-30 -bottom-0.5 flex items-center justify-between shadow-bottomNavigation body-font bg-skin-fill w-full h-14 px-4 md:px-6 lg:px-8 text-skin-muted pb-0.5">
        <button
          aria-label="Menu"
