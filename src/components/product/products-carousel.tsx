...
// import { Product } from '@/framework/basic-rest/basic-rest/types';
...
const ProductsCarousel: React.FC<ProductsCarouselProps> = observer(({
  sectionHeading,
  categorySlug,
      ...
      {error ? (
        ...
        <div className="heightFull xl:-me-40 2xl:-me-28 4xl:me-0 relative after-item-opacity">
          <Carousel
            ...
            nextButtonClassName={`-end-2 xl:end-40 -top-12 3xl:top-auto transform 2xl:translate-x-0 3xl:-translate-y-2 4xl:-translate-y-10 ${dir === 'rtl' ? 'xl:-translate-x-2.5' : 'xl:translate-x-2.5'
              }`}
          >
