...
const OrderInformation = observer(() => {
  ...
  return (
    <div className="xl:px-32 2xl:px-44 3xl:px-56 py-16 lg:py-20 svedwrfeg">
      ...
      <ul className="border border-skin-base bg-skin-secondary rounded-md flex flex-col md:flex-row mb-7 lg:mb-8 xl:mb-10 items-center wfqegrveasvdeqwv" style={{width:'fit-content', margin: '0 auto', marginBottom: '30px'}}>
