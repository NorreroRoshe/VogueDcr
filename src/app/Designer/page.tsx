    ...
    <section className={cls.section_collaboration}>
      <div className={`${cls.collaboration_container} ${cls.container}`}>
        ...
        <div className={cls.collaboration_desc}>
          ...
          <p className={cls.desc_txt}>
            Наша компания ценит долгосрочные и взаимовыгодные отношения, поэтому предоставляет партнерам <b>специальные предложения, скидки и условия работы</b>. Для получения подробной информации отправьте запрос на <span>эл.почту <a href="mailto:info@Vogue-Decor.ru">info@Vogue-Decor.ru</a>, прикрепив ссылку на ваш сайт/соц.сети/диплом.</span>
          </p>
          <p className={cls.desc_txt}>
        ...
        <table>
          <tbody>
            <tr><td>E-Mail</td><td><a className={cls.cooperation_content} href="mailto:info@Vogue-Decor.ru">info@Vogue-Decor.ru</a></td></tr>
